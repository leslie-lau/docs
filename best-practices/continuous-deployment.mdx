...
## When to create a feature flag[​](#when-to-create-a-feature-flag "Direct link to When to create a feature flag")
...
## Using Targeting Rules for CI/CD[​](#using-targeting-rules-for-cicd "Direct link to Using Targeting Rules for CI/CD")
...
![targeting the server storage team](/images/best-practices/assets/images/august-2022-targeting-ci-4c834e1ff86bb210cf0f1eea4d7e07b0.png)
...
## Testing Code that Uses Feature Flags[​](#testing-code-that-uses-feature-flags "Direct link to Testing Code that Uses Feature Flags")
...
```
const useServerStorage = useVariable('use-server-storage', false)if (useServerStorage) {  retrieveDataFromServer() // function for using server storage} else {  retrieveDataFromLocal() // function for using local storage}
```
...
[Edit this page](https://github.com/devcyclehq/devcycle-docs/edit/main/docs/best-practices/continuous-deployment.md)
