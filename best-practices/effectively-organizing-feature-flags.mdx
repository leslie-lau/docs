...
## Feature Grouping using Variables[​](#feature-grouping-using-variables "Direct link to Feature Grouping using Variables")
...
## Linking Your Features to Jira Tickets[​](#linking-your-features-to-jira-tickets "Direct link to Linking Your Features to Jira Tickets")
...
![jira settings](/images/best-practices/assets/images/feb-2022-jira-settings-0544016e88b6d4dcaa83677b03fab6ed.png)

Simply enter the IDs of the ticket(s) you’d like to associate with the feature.

![image](/images/best-practices/assets/images/feb-2022-jira-ids-entered-1d81b77b0c16cac38d81dd6c00579991.png)
...
![jira sidebar](/images/best-practices/assets/images/feb-2022-within-jira-b3e2c26dacf74c57528d08d7202e09bf.png)

Clicking this will display all the feature status information across all environments:

![jira sidebar](/images/best-practices/assets/images/feb-2022-jira-example-14a094d7ec3967f33456a0db2acdc674.png)
...
## Using Code References to Track Variable Usage[​](#using-code-references-to-track-variable-usage "Direct link to Using Code References to Track Variable Usage")
...
![march-2022-code-refs](/images/best-practices/assets/images/march-2022-code-refs-8b75901d5c41db718d7ce2e0bdc56573.png)
...
[Edit this page](https://github.com/devcyclehq/devcycle-docs/edit/main/docs/best-practices/effectively-organizing-feature-flags.md)
