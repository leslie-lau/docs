...
<Info>
  Stale Feature Notifications are a Business feature. To learn more, read about our [pricing](https://devcycle.com/pricing). To upgrade your plan, please update your plan on your Billing Information page which can be found in your organization's Settings, or contact [Sales](/cdn-cgi/l/email-protection#9ae9fbf6ffe9dafeffecf9e3f9f6ffb4f9f5f7).
</Info>
...
## Stale Feature Reasons[​](#stale-feature-reasons "Direct link to Stale Feature Reasons")

<Note>
  Stale Feature detection relies on Variable evaluations triggered through the `.variable()` or `.variableValue()` SDK call. If your implementation uses `.allVariables()` or `.allFeatures()`, these calls do **not** generate evaluation data. As a result, Features may appear **Unused** and be marked stale even if they are actively used in your code. If you know the Feature is active and used via `.variable()` or `.variableValue()` you can choose to:
  ...
  * **Uncheck "Unused"** as a staleness check type in your Project Settings to prevent similar cases. If you're unsure whether evaluations are occurring, contact Support with the Variable key name so we can investigate further.
</Note>

Features can belong to one of the following staleness reasons:

### Unmodified[​](#unmodified "Direct link to Unmodified")

#### Short-Lived[​](#short-lived "Direct link to Short-Lived")
...
#### Long-Lived[​](#long-lived "Direct link to Long-Lived")
...
### Released[​](#released "Direct link to Released")
...
### Unused[​](#unused "Direct link to Unused")
...
## Enabling Stale Feature Notifications for your Project[​](#enabling-stale-feature-notifications-for-your-project "Direct link to Enabling Stale Feature Notifications for your Project")
...
![image of settings page](/images/platform/feature-flags/assets/images/apr-2025-stale-flag-settings-email-fee896a7e75be99f085e14805d42ea29.png)

## Stale Feature Notifications on the Dashboard[​](#stale-feature-notifications-on-the-dashboard "Direct link to Stale Feature Notifications on the Dashboard")

You can find a list of stale Features on the main landing page of DevCycle.

![image of home page](/images/platform/feature-flags/assets/images/nov-2024-stale-feat-home-page-3821c14ba4da79fdecfca8fdb9fc3e1d.png)

On the **Feature List** page, stale Features are marked with an exclamation point next to their status label. Hover over the status to see the specific staleness reason. diff

![image of list page hover](/images/platform/feature-flags/assets/images/nov-2024-stale-feat-list-page-hover-e15860a633fd136b481d939f5fd54d1f.png)

You can also filter for all stale Features or specific staleness reasons on the Feature list page.

![image of list page](/images/platform/feature-flags/assets/images/nov-2024-stale-feat-list-page-c98bd7758d403383936b87ab31103d14.png)

## Snoozing & Disabling Stale Feature Notifications[​](#snoozing--disabling-stale-feature-notifications "Direct link to Snoozing & Disabling Stale Feature Notifications")
...
![image of snooze](/images/platform/feature-flags/assets/images/nov-2024-stale-feat-snooze-68e3cbb061f3edb5cc8d582b21d74899.png)

To **unsnooze** or change the snooze period, click the **Unsnooze** button.

![image of unsnooze](/images/platform/feature-flags/assets/images/nov-2024-stale-feat-unsnooze-fa6a671198bec8cb9b83cfe28d8508fa.png)
...
![image of enable staleness checks](/images/platform/feature-flags/assets/images/nov-2024-stale-feat-disable-caf4e187cad90d108c0dd94fabfa36d7.png)

## Stale Feature Report Email Notifications[​](#stale-feature-report-email-notifications "Direct link to Stale Feature Report Email Notifications")
...
![staleness email example](/images/platform/feature-flags/assets/images/apr-2025-stale-email-ex-e636d13fb3bdf503a3b91cdb3454cf99.png)

Choose your preferred frequency—**Weekly, Bi-Weekly, or Monthly**—and specify who should receive the emails.

![stale feature setttings section](/images/platform/feature-flags/assets/images/apr-2025-stale-flag-settings-email-fee896a7e75be99f085e14805d42ea29.png)
...
[Edit this page](https://github.com/devcyclehq/devcycle-docs/edit/main/docs/platform/feature-flags/stale-feature-notifications.md)
