---
title: "Status and Lifecycle Management in DevCycle"
description: "In DevCycle, Features have  which indicate their current position in the Development LifeCycle. The statuses are a succinct way to understand a Feature's state, and each status has its own unique properties."
---
...
### In Progress[​](#in-progress "Direct link to In Progress")
...
## LifeCycle and Changing Status[​](#lifecycle-and-changing-status "Direct link to LifeCycle and Changing Status")

### Completing a Feature[​](#completing-a-feature "Direct link to Completing a Feature")
...
### Cleanup Checklist for Variables[​](#cleanup-checklist-for-variables "Direct link to Cleanup Checklist for Variables")
...
#### Reverting to In Progress[​](#reverting-to-in-progress "Direct link to Reverting to In Progress")
...
[Edit this page](https://github.com/devcyclehq/devcycle-docs/edit/main/docs/platform/feature-flags/status-and-lifecycle.md)
