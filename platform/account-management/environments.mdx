---
title: "Environments"
description: "Environments in DevCycle map to the environments which traditionally exist within a system's development lifecycle. Every Feature within DevCycle will exist across every Environment in your DevCycle Project, but each Environment manages Features independently."
---

> For example, a Feature may exist on your Production, Staging, and Development Environment, but may only be *turned on* for the Development Environment.
...
**By default, only the environments for the *last viewed project* will be shown**. To change the Project which you'd like to manage the Environments for, use the projects dropdown here:
...
## Creating a new Environment[​](#creating-a-new-environment "Direct link to Creating a new Environment")
...
## Updating an Environment[​](#updating-an-environment "Direct link to Updating an Environment")
...
## Deleting an Environment[​](#deleting-an-environment "Direct link to Deleting an Environment")
...
[Edit this page](https://github.com/devcyclehq/devcycle-docs/edit/main/docs/platform/account-management/environments.md)
