...
## Types of Keys[​](#types-of-keys "Direct link to Types of Keys")

### SDK Keys[​](#sdk-keys "Direct link to SDK Keys")
...
#### Client Key[​](#client-key "Direct link to Client Key")
...
#### Mobile Keys[​](#mobile-keys "Direct link to Mobile Keys")
...
### Management API Key[​](#management-api-key "Direct link to Management API Key")
...
[Edit this page](https://github.com/devcyclehq/devcycle-docs/edit/main/docs/platform/account-management/keys.md)
