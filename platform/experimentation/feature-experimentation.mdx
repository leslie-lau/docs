...
## Why Experiment[​](#why-experiment "Direct link to Why Experiment")
...
## Using Experimentation[​](#using-experimentation "Direct link to Using Experimentation")
...
### Comparing Multiple Variations[​](#comparing-multiple-variations "Direct link to Comparing Multiple Variations")
...
![Random Distribution 50/50](/images/platform/experimentation/assets/images/feature-experiment-5050-6337ddf0a238f766f49352ecf668558b.png)

## Adding Metrics to Your Feature[​](#adding-metrics-to-your-feature "Direct link to Adding Metrics to Your Feature")
...
![Add Metrics from Feature Editing Page](/images/platform/experimentation/assets/images/add-metric-feature-page-789c514e556346d1855b6df5ed6f03b3.png)
...
![Adding a Metric](/images/platform/experimentation/assets/images/feature-experiment-control-metric-7454ddde27c0ee9255260b17d285f6bb.png)
...
![Reviewing Metric Performance](/images/platform/experimentation/assets/images/feature-experiment-full-results-7daadf034d30d8f3a37d25c3c72f9ed2.png)
...
## Determining a Winner[​](#determining-a-winner "Direct link to Determining a Winner")
...
![Positive Metric Results](/images/platform/experimentation/assets/images/feature-experiment-positive-results-08781c694657fe98a0bbcd9c69e8d789.png)

**Negative Results**

![Negative Metric Results](/images/platform/experimentation/assets/images/feature-experiment-negative-results-a79223cfdc6240fb5fedcc2873f77089.png)

## Experimentation using a Custom Property for Randomization[​](#experimentation-using-a-custom-property-for-randomization "Direct link to Experimentation using a Custom Property for Randomization")
...
### What are Experiments that Randomize Using a Custom Property?[​](#what-are-experiments-that-randomize-using-a-custom-property "Direct link to What are Experiments that Randomize Using a Custom Property?")
...
![Randomization Grouping](/images/platform/experimentation/assets/images/custom-property-groups-63f1c2b0b05f165c2c10eefb133205c0.png)

### How to Randomize Using a Custom Property in Experiments[​](#how-to-randomize-using-a-custom-property-in-experiments "Direct link to How to Randomize Using a Custom Property in Experiments")
...
![Experimentation with Custom Property Randomization](/images/platform/experimentation/assets/images/custom-property-randomization-experiments-8bb30630c9e5a36b6b2812b8f6409d7b.png)

### Risks to Experimentation[​](#risks-to-experimentation "Direct link to Risks to Experimentation")
...
[Edit this page](https://github.com/devcyclehq/devcycle-docs/edit/main/docs/platform/experimentation/feature-experimentation.md)
